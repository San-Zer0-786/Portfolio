...
function university_custom_rest() {
  ...
  register_rest_field('note', 'userNoteCount', array(
    'get_callback' => function() {return 
      count_user_posts( get_current_user_id(), 'note');}
  ));
}
...
function addAdminMenu() {
  ...
  add_menu_page( 'My First Plugin Options', 'My First Plugin', 'manage_options', 'my_first_plugin_options', 'MyFirstPluginContent'  );
...
function MyFirstPluginContent() {
  
  echo "<p> I am plug in content";
